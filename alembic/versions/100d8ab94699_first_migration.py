...
Revision ID: 100d8ab94699
Revises: 
Create Date: 2022-12-31 11:52:54.161944
...
def upgrade() -> None:
    ...
    op.add_column(
        'content_blocks',
        sa.Column('description', sa.Enum('lesson', 'quiz', 'assignment', name='contenttype'), nullable=True),
    )
    ## End of custom code
